...
- [`2026-07-22_stage7_calibration_and_external_ik.md`](2026-07-22_stage7_calibration_and_external_ik.md) — Stage 7 plan: real User Frame calibration, real TCP offset, rejection-criteria self-check, and job export to the external IK exchange format. Feeds `tutorials/Stage7_README.md`.
